...
// determine which value occurs twice. Write a function that will find and return 
// the duplicate value that is in the array.

function findDup(array) {
  return array.find(element => array.indexOf(element) !== array.lastIndexOf(element));
}
