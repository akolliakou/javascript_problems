// In this exercise, you will learn more about Arrays by implementing your own version of 
// the Array.prototype.concat method. Write a function that returns a new array composed of 
// all values from the first array argument and the second array or value argument. 
...
function concat(array1, secondArgument) {
  ...
  if (Array.isArray(secondArgument)){
    for (let index = 0; index < secondArgument.length; index += 1) {
      concatenatedArray.push(secondArgument[index]);
    }
  } else {
